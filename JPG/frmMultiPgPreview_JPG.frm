...
Private Sub cmdOpen_Click()
  ...
  Dim i As Integer
    ...
    For i = 0 To PageNumber
       FileCopy TempDir & "PPview" & CStr(i) & ".JPG", FolderName & ReportTitle & CStr(i + 1) & ".JPG"
